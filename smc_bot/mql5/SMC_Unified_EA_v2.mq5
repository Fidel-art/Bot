...
input double        LotPerK            = 0.03;       // lots per $10 balance
input double        BagProfitPercent   = 10.0;        // close all at +x% equity
input double        BagLossPercent     = 3.0;        // close all at -y% equity
...
double CalculateLotSize()
{
   ...
   double lots = LotPerK * (balance / 10.0);
